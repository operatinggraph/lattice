...
func main() {
	...
	ddlChecks := []ddlCheck{
		...
		{canonical: "patientSelfDayClaim", class: "meta.ddl.aspectType", ops: []string{"CreateAppointment", "RescheduleAppointment", "SetAppointmentStatus", "MarkPastDueNoShow", "TombstoneAppointment"}},
