...
// (in production, *loom.Engine) and a CapabilityChecker (in production, a stub
// allow-all — real Capability KV check is a Phase 3 carry).
type Service struct {
...
// StubCapabilityChecker is used in that case. logger may be nil — slog's default
