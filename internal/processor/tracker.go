...
// #4 §4.3). 24h is the architecture-locked default. The value is owned by
// internal/opstatus — the leaf that hosts the RPC projecting these trackers
// and that every reader of tracker-absence compares against — so the writer
