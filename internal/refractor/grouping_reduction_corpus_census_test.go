...
var corpusGroupingVerdicts = map[string]groupingVerdict{
	...
	"landlordLeaseApplicationsRead":     {"key(applicantEmailEnv applicantKey applicantNameEnv applicantPhoneEnv declineReason employmentVerified entityKey guarantorIncomeToRentMet hasCoApplicant hasGuarantor incomeToRentMet landlordDecision landlordKey profileSubmitted referenceCount signedAt ssnVal tenancyEndedAt tenancyLeaseEnd tenancyLeaseStart tenancyRentAmount tenancyTermStart termsLeaseTermMonths termsMoveInDate termsRequestedRent u unitAddress unitCity unitCurrency unitKey unitRegion unitRent unitStatus) p!applicantEmailEnv", 0},
	...
	"leaseApplicationsRead":             {"key(applicantKey declineReason employmentVerified entityKey guarantorIncomeToRentMet hasCoApplicant hasGuarantor incomeToRentMet landlordDecision profileSubmitted referenceCount signedAt ssnVal tenancyEndedAt tenancyLeaseEnd tenancyLeaseStart tenancyRentAmount tenancyTermStart termsLeaseTermMonths termsMoveInDate termsRequestedRent unitAddress unitAvailableFrom unitBathrooms unitBedrooms unitCity unitCurrency unitKey unitRegion unitRent unitStatus) p!applicantKey", 0},
	...
	"providerSites":                     {"p", 0},
	"renewalComplete":                   {"key(entityKey guarantorVerifiedAt hasGuarantor leaseAppKey leaseappAlive signalsSubmittedAt signedAt status tenant termsSetAt termsTermMonths) p!leaseAppKey", 0},
