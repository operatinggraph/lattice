...
var corpusGroupingVerdicts = map[string]groupingVerdict{
	...
	"landlordLeaseApplicationsRead":     {"key(applicantEmailEnv applicantKey applicantNameEnv applicantPhoneEnv declineReason employmentVerified entityKey guarantorIncomeToRentMet hasCoApplicant hasGuarantor incomeToRentMet landlordDecision landlordKey profileSubmitted referenceCount signedAt ssnVal tenancyEndedAt tenancyLeaseEnd tenancyLeaseStart tenancyRentAmount tenancyTermStart termsLeaseTermMonths termsMoveInDate termsRequestedRent u unitAddress unitAvailableFrom unitCity unitCurrency unitKey unitLeaseTermMonths unitRegion unitRent unitStatus) p!applicantEmailEnv", 0},
	...
	"leaseApplicationsRead":             {"key(applicantKey declineReason employmentVerified entityKey guarantorIncomeToRentMet hasCoApplicant hasGuarantor incomeToRentMet landlordDecision profileSubmitted referenceCount signedAt ssnVal tenancyEndedAt tenancyLeaseEnd tenancyLeaseStart tenancyRentAmount tenancyTermStart termsLeaseTermMonths termsMoveInDate termsRequestedRent unitAddress unitAvailableFrom unitBathrooms unitBedrooms unitCity unitCurrency unitKey unitLeaseTermMonths unitRegion unitRent unitStatus) p!applicantKey", 0},
	"leaseExpiry":                       {"key(endedAt entityKey landlordDecision lapsedAt leaseEnd renewalOpensAt signedAt unitKey) p!endedAt", 0},
