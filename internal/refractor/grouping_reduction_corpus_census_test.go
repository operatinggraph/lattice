...
var corpusGroupingVerdicts = map[string]groupingVerdict{
	...
	"tenancyEnd":                        {"key(endedAt entityKey landlordDecision lapsedAt leaseEnd moveOutAt residenceLinkKey signedAt termEnd unitKey unitStatus) p!landlordDecision", 0},
