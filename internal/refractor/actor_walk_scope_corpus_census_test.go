...
var corpusActorWalkScopeDigests = map[string]string{
	...
	"clinicArrearsReminders":         "clinicaccount:heldFor|patient:heldFor",
	...
	"edgeEntitySessions#0":           "booking:forSession|identity:residesIn|instructor:ledBy|session:atStudio,forSession,ledBy|studio:atStudio,locatedAt|any:containedIn,locatedAt,residesIn",
	"edgeEntitySessions#1":           "booking:forSession|identity:identifiedBy|instructor:identifiedBy,ledBy|session:atStudio,forSession,ledBy|studio:atStudio",
	...
	"workOrderQueue":                    "identity:reportedBy|task:scopedTo|workorder:reportedBy,scopedTo",
	"staleWorkOrderTasks":               "identity:assignedTo|task:assignedTo,scopedTo|workorder:scopedTo",
	"workOrderResolvedNotices":          "identity:reportedBy|workorder:reportedBy",
}
