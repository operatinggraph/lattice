...
var corpusLabelVerdicts = map[string]labelVerdict{
	...
	"clinicAppointmentsRead":            {narrow, "appointment building patient provider"},
	...
	"providerAppointmentsRead":          {narrow, "appointment building patient provider"},
	...
	"visitSeriesRead":                   {narrow, "building patient provider visitseries"},
