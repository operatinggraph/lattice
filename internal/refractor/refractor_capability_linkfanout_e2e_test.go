...
func TestRefractor_CapabilityLens_LinkFanOut_E2E(t *testing.T) {
	...
	// (cap.roles.<actor>); this exercises link fan-out reprojection on that
	// actor-aggregate lens. The spec is compiled directly from the package
	// declaration, mirroring how a package lens activates. ---
