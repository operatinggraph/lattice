...
// lines apart. Reason is empty for a debit (charge-only rows never carry it)
// and "payment"/"waiver" for a credit — the FE labels a waiver distinctly so
// forgiven debt is never mistaken for cash collected.
