...
func TestRosterCard_WaitlistedBookingNeverOffersAttendance(t *testing.T) {
	vm := webHelperVM(t, "esc", "shortKey", "idOf", "nameForIdentity", "arrearsBadgeText", "fmtTime", "fmtDay", "promotedBadge", "toldBadge", "movedBadge", "instructorChangeBadge", "roomChangeBadge", "reminderBadge", "money", "resolveNoShowFeeCents", "noShowLabel", "attendanceActions", "seatCancelAction", "rosterCard")
