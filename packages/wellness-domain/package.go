...
//	  collision) / TombstoneSession (releases the held cells; does NOT
//	  cascade to bookings — see ReleaseOrphanedBooking below)
...
//	  booking still cancels cleanly) / ReleaseOrphanedBooking (operator-only,
