...
// in lockstep (the lease-signing precedent): the install reads the Definition,
...
func TestPackage_StructurePins(t *testing.T) {
	...
	wantPerms := []struct{ op, scope string }{{"LoftspaceCreateAccount", "any"}, {"LoftspaceCreateAccount", "self"}, {"DebitAccount", "any"}, {"CreditAccount", "any"}, {"CreditAccount", "self"}, {"LoftspaceRecordCharge", "any"}, {"LoftspaceRecordCharge", "self"}, {"ReturnDeposit", "any"}, {"RecordDepositDeduction", "any"}, {"RecordDepositDeduction", "self"}, {"PayOutBalance", "any"}, {"PayOutBalance", "self"}, {"LinkReversal", "any"}, {"EvaluateLoftspaceArrears", "any"}, {"RecordLoftspaceArrearsReminderNotification", "any"}}
