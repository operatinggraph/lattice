...
//
// Thirteen ops (known-key kv.Read only — no kv.Links enumeration, no raw prefix
...
//	                   project) / MarkPastDueNoShow (Weaver-dispatched only — clinic-reminders'
...
//	                   patient resolved live instead of caller-supplied) / TombstoneAppointment
//
