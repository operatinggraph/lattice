...
// Definition in lockstep (the loftspace-ledger/cafe-ledger precedent): the
...
func TestPackage_StructurePins(t *testing.T) {
	...
	wantLenses := []string{"oneBillRentEntries", "oneBillCafeEntries", "oneBillClinicEntries", "oneBillWellnessEntries"}
