...
func setupBcEnv(t *testing.T) (context.Context, *substrate.Conn) {
	...
	inst.RoleIDs = map[string]string{"operator": bootstrap.RoleOperatorID, "consumer": bcConsumerRoleID, "frontOfHouse": pkgmgr.RoleID("identity-domain", "frontOfHouse"), "backOfHouse": pkgmgr.RoleID("identity-domain", "backOfHouse")}
