...
func renewalDDL() pkgmgr.DDLSpec {
	return pkgmgr.DDLSpec{
		...
		InputSchema: `{"type":"object","properties":` +
			...
			`"rentAmount":{"type":"number","description":"The adjusted monthly rent for the renewed term (SetRenewalTerms; required, > 0, at most two decimals — the ledger keeps whole cents)."},` +
		...
		FieldDescription: map[string]string{
			...
			"rentAmount": "The adjusted monthly rent for the renewed term (SetRenewalTerms; required, > 0, at most two decimals — InvalidArgument otherwise). Stored on the .terms aspect.",
