...
| 1.5.6 | Re-enable Hello Lattice M4+M6 (M5 deferred) | 🟡 PARTIAL — M1–M4+M6 pass, Gate 5 partial (CI green) | `a6edcb0` |
| 1.5.8 | Non-atomic step-9 event publish → close M5 + Gate 5 | queued (Wave E — next; unblocks M5) | — |
