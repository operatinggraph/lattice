...
a marker delivered after the tracker has aged out reaches absences that decide nothing — the probe
refuses the verdict there, alerting and parking the instance rather than failing it
(`lattice-designer-triage-2026-09-10.md` §3, shipped). One hour keeps the widest
