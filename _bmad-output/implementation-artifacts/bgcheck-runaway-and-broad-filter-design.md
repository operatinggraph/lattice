...
([bgcheck-supersession-convergence-rule-design.md](bgcheck-supersession-convergence-rule-design.md), `b86e000` +
`ac13dbb`): a lens projects the superseded pair and Weaver's `directOp` submits the §6 op; history is a record at
