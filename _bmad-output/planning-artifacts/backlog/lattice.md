...
> grant keys** fix (★★ L) is now `🏗️ building` — Fire 1 increments 1–4 (descriptor field, driver
> perEntry emission, core prefix-diff retraction, actor-disappearance retraction) shipped; next
> is the shred-site prefix enumeration + §4.3/§4.4. `appsession`'s OIDC design stays
