...
| **[Refractor] Capability-plane lenses wedged rebuilding, backlog barely draining** | Throughput-bound, not wedged: 1.11 CDC msg/s combined; the sweep stays suppressed for the rebuild's duration. Mac-only (needs the live stack). | ★★ | S–M | 🏗️ owner: steward-lattice-guarded-audit-decline · [design](../../implementation-artifacts/capability-plane-rebuild-throughput-design.md) · next: gate audit on a committed guarded write |
