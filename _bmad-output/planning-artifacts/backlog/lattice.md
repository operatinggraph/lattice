...
| **[Weaver] HealthSink pause-restore round-trip uncovered** | `consumerHealthSink.Load` paused-restore branch + `pauseReasonFromString` sit at 0% coverage. | ★★ | XS–S | ✅ ratified (2026-07-02, Fire 3 Bridge included) · [design](../../implementation-artifacts/health-sink-consolidation-design.md) · 3 fires |
...
> the design's build-start addendum; unblocks 3 Verticals rows).
