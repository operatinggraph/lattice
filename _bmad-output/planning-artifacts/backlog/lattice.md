...
> grant keys** fix (★★ L) is now `🏗️ building` — Fire 1 increments 1–5 (descriptor field, driver
> perEntry emission, core prefix-diff retraction, actor-disappearance retraction, shred-site prefix
> enumeration) shipped; next is §4.3/§4.4. `appsession`'s OIDC design stays
