...
> grant keys** fix (★★ L) is now `🏗️ building` — Fire 1 increment 1 (entryKeyColumn descriptor
> field) shipped; next increment is driver perEntry emission. `appsession`'s OIDC design stays
