...
> grant keys** fix (★★ L) is now `🏗️ building` — Fire 1 increments 1–6 (descriptor field, driver
> perEntry emission, core prefix-diff retraction, actor-disappearance retraction, shred-site prefix
> enumeration, retry-path refusal) shipped; next is §4.4 sweep deltas. `appsession`'s OIDC design stays
