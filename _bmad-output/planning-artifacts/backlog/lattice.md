...
> grant keys** fix (★★ L) is now `🏗️ building` — Fire 1 increments 1–3 (descriptor field, driver
> perEntry emission, core prefix-diff retraction) shipped; next is the remaining §4.2 delete
> consumers + §4.3/§4.4. `appsession`'s OIDC design stays
