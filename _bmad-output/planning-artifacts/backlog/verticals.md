...
| **The 4 stale cluster-A onboarding cards need a live CancelTask pass** | Inc 2 of the onboarding re-anchor: 4 open `RecordIdentityPII` tasks predate the Inc 1 fix and won't self-clear; their identity reads `protected: true` — ground why before touching it. | LoftSpace | platform | ★ | XS | 🚧 blocked-on: grounding pass, [design](../../implementation-artifacts/duplicate-human-task-fanout-design.md) build note |
