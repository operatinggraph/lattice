...
| **A member seated from the waitlist, moved, or called off hears nothing** | Only the 24 h reminder and the arrears reminder ever go out; a promotion (`promotedAt`), a time move, and a call-off change the member's seat, charge, or refund in silence. Live: Alex was seated + charged $10 at 20:41Z for a Sep 20 class, next word due Sep 19 15:00Z. | Wellness | pkg + FE | ★★ | M | 🏗️ building · [design](../../../docs/reviews/wellness-booking-change-notices-2026-09-16.md) · next: Inc 1 the domain replyOp + release emission |
