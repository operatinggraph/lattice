...
| **The patient-facing site picker offers a verify artifact as a clinic** | `/api/sites` returns 2 sites, one of them "PO Discovery Test Site", and the roster carries 5 duplicate "Classic Demo Patient" rows plus "Grid Snap Test"/"Post-Merge Verify"/"Inc2a Live Verify" patients — clinic verify fires mint demo-visible entities and never reap them. Reap precedent: `8f9b0633`, `533f639e`. | Clinic | pkg | ★ | S | 📋 ready |
