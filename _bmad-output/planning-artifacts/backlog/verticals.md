...
- 2026-09-18 · `fb335b71` · The house limit bounds what a resident owes — the ledger balance joins the self-leg `TabLimitExceeded` bound; card, picker, POS read it; live ([design](../../../docs/reviews/cafe-house-tab-limit-2026-09-16.md)).
- 2026-09-18 · `fb335b71` · The POS picker finds a resident — `rankLeaseOptions` (open tab first, billable by name, *Not billable* trailing) + a type-to-find that rebuilds the options; live.
- 2026-09-18 · `fb335b71` · The café statement stamps every entry local — `postedAt` through `localDateTime`, the refund dialog included; live.
