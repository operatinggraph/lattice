...
| **A waitlister seated inside the late-cancel window is charged and cannot back out** | Both promotion paths seat a waitlister until `startsAt` ([lenses.go:689](../../../packages/wellness-domain/lenses.go:689)), so a seat handed 63 min out is charged under the 2 h forfeit ([ddls.go:3894](../../../packages/wellness-domain/ddls.go:3894)); no `promotedAt` recorded, the flip is silent. Live: two forfeits, $20, a 1-seat class ran empty. | Wellness | pkg + FE | ★★★ | M | 🏗️ building · [design](../../../docs/reviews/wellness-late-promotion-2026-09-15.md) · next: Inc 1 package |
