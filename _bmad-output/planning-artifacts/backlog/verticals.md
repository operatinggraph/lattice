...
|---|---|---|---|---|---|---|
| **Sibling-form class → `lint-refusal-courtesy`** | A refusal added to one form leaves its sibling (or another client) a dead end — three sightings, never mechanized; every dispatch site of a multi-site op declares its courtesy per state code, default-deny, stale-checked. | Cross-vertical | Steward | ★★ | L | 🏗️ building · [brief](../../../docs/reviews/verticals-refusal-courtesy-gate-2026-09-15.md) · next: the gate + census |
