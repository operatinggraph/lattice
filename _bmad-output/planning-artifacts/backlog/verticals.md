...
| **The desk's No-show click bills an undisclosed flat $25 on top of the class price** | The roster button says only "No-show" and sends no fee, so `SetBookingAttendance`'s 2500 default applies: a $0 resident class no-show costs $25, a $15 guest $40; the studio has no fee policy. A studio-level `noShowFeeCents`, the button states the amount, the desk may mark fee-free. | Wellness | pkg + FE | ★★ | S | 🏗️ building · [design](../../../docs/reviews/wellness-noshow-fee-2026-09-15.md) · next: Inc 1 package |
