...
| **The follow-up worklist reads empty while 8 follow-ups stand outstanding** | `hasLaterVisit` ([app.js:2718](../../../cmd/clinic-app/web/app.js:2718)) clears a follow-up on ANY later non-cancelled appointment and never consults its `followUpDate`: a visit documented 09-15 due 09-29 was addressed by a merely-`scheduled` 09-17 booking. 8 of 8 live rows hidden. | Clinic | FE | ★★★ | XS | 📋 ready · address only a visit on/after `followUpDate` |
