...
| **"Rent owed" never says how late** | The portfolio list ranks balances by amount and neither it nor the statement reads the recorded `dueAt` ([lenses.go:84](../../../packages/loftspace-ledger/lenses.go:84)); a bill posted today and one 40 days overdue read alike, and no debtor is ever reminded. "Due in N days" / "N days overdue" per lease; one reminder per arrears episode (the café/wellness `.arrears` idiom). | LoftSpace | pkg + FE | ★★ | M | 🏗️ building · [design](../../../docs/reviews/loftspace-rent-arrears-2026-09-15.md) · next: Inc 1 loftspace-ledger |
