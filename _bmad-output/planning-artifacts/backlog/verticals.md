...
| **A wellness debtor is never told, never reminded, and books unasked** | The statement says "Balance owed" with no due date or overdue flag; no arrears reminder op / notification exists (café precedent); a 3-day-overdue member self-books unasked (live: Alex Kim, $20). Mirror café: reminder recorded + shown, `CreateBooking` refuses `CreditHold` off it. | Wellness | pkg + FE | ★★ | M | 🏗️ building · [design](../../../docs/reviews/wellness-arrears-reminder-2026-09-15.md) · next: Inc 1 wellness-ledger arrears |
